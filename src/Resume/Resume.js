    ...
    <div className="mt-3 col-12">
        <Terminal icon="fas fa-user-tie" title="Work Experience" bodycolor={colors['red']} textcolor="#FFF">
          ...
          <div className="row p-2">            
            <div className="col-sm-5 col-md-4 col-xl-4 mb-3 logo-container">
            ...
            <div className="col-sm-7 col-md-8 col-xl-8 float-left">
              {jobs.map((arr) => (
                <div  >
                  {/* <hr className="m-1"></hr> */}
                    <div>
    ...
    <div className="mt-3 col-12">
        <Terminal icon="fas fa-user-graduate" title="Education" bodycolor={colors['navy']} textcolor="#FFF">          
          {education.map((arr) => (
            ...
            <div className="row">
              <div className="col-xs-2 col-md-4 col-lg-3 mb-3 text-center">
              ...
              <div className="col-xs-2 col-md-8 col-xl-9 float-left">
                <div>
