        ...
        <div className="bucket">
            <div className="titlebar less-black">
                <div className="py-1" style={{"paddingLeft":"15px","fontSize":"1.2em"}}>
                    <span className="title-span mt-2 " >
                        <i  className={props.icon+" drop-shadow-text"} style={{"paddingRight":"15px"}}></i>{props.title}</span>
            ...
            style={{"backgroundColor":props.bodycolor,
                    ...
                    <div className="mb-0 terminal-body drop-shadow-text-small">{props.children}</div>
            </div>
        </div>
    )
}
